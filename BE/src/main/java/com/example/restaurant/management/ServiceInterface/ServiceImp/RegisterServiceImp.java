...
@Transactional
@Service
public class RegisterServiceImp implements com.example.restaurant.management.ServiceInterface.RegisterService {
    ...
    public void registerShopManager(ShopManagerRegister shopManagerRegister) {
        ...
        Roles defaultRole  = rolesRepository.findByRoleName("ROLE_SHOP_MANAGER");
        User user = new User();
